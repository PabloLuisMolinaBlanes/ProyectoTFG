/*Código tomado del repositorio original de Lê Trung Kiên. Archivo relevante: https://github.com/ltkdt/LTKDT-s_small_projects/blob/master/esp_idf_adc/main.c. Perfil en GitHub: https://github.com/ltkdt*/
