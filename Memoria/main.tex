...
Es mi Trabajo de Fin de Grado para mi Grado en Ingeniería del Software en la Universidad de Málaga

\medskip

\noindent\textbf{Palabras clave:}  evaluación,programa,datos

\end{abstract}

\renewcommand{\abstractname}{Abstract}
\begin{abstract}
FOSS Psychotechnical Examination is meant to be a FOSS recreation of a psychotechnical examination software suite. 

It features embedded, system software, and application software components. 

It is my Capstone Project (called 'Trabajo de Fin de Grado' in Spanish) for my Software Engineering degree in Universidad de Málaga

\medskip

\noindent\textbf{Palabras clave:} examination,program,data 
...
Dispone de componentes software para sistemas empotrados, de software de aplicación, y de software local y en nube.

\section{¿Por qué existe este proyecto?}

\subsection{Efectos del código cerrado en este tipo de proyectos}
...
Los sistemas de evaluación psicotécnicos forman un rol crítico en España para indicar quién podrá conducir, y a quién se le habrá de retirar dicho privilegio; si estos sistemas son cerrados y opacos en su código; no podremos saber qué criterios se utilizan para medir la capacidad psicotécnica de un conductor; tampoco podremos examinar el código para detectar fallos de programación que puedan causar injusticias sociales en el mundo real.

\subsection{El importante rol de la recreación}

Recrear un proyecto tan establecido desde hace mucho tiempo nos permite aplicar nuevas técnicas y estrategias a una base completamente distinta sobre la que trabajar. La recreación no se suele considerar habitualmente como innovación, y no se valora como esfuerzo original y propio en muchos campos, se refleja este estigma en frases comunes como "no reinventes la rueda". 

Pero es gracias a la recreación que podemos conocer cuándo una técnica funciona de forma consistente, y podemos establecer qué es lo que funciona, y lo que no.

La recreación es lo que nos permite evaluar de forma más objetiva qué es lo que funciona, y qué es lo que no funciona, o es más secundario; incluso nos permite obtener nuevo conocimiento ya que aplicamos nuevos marco y contextos técnicos, legales, sociales, industriales, entre otros; proporcionándonos otros puntos de vista relativos a lo que se recrea.

En resumen, con las nuevas tecnologías y buenas prácticas de las que disponemos, es especialmente importante la replicación, nos permite desarrollar sobre las fórmulas que ya funcionaron en el pasado, y obtener nuevo conocimiento gracias a esta tarea de adaptación a un mundo distinto.

\section{Objetivos principales del Trabajo}

\begin{enumerate}
  \item Realizar un prototipo bajo licencias permisivas de suite software para la evaluación psicotécnica de conductores, adaptada al hardware elegido.
  \item Diseñar un proyecto software multidisciplinar, siguiendo las medidas de seguridad y de calidad del software más ampliamente reconocidas en el sector tecnológico.
  \item Realizar documentación técnica y manuales de usuario e instalación adecuada dirigida hacia cada segmento de audiencia que pueda estar interesado en el proyecto
\end{enumerate}
\subsection{Objetivos para el componente de software para sistemas empotrados}

\begin{enumerate}
  \item Realizar un componente software que implemente funcionalidades para la recolección de datos desde dispositivos electrónicos, y el envío de estos datos, de forma que colabore con los objetivos principales del trabajo.
\end{enumerate}

\subsection{Objetivos para el componente de software de aplicación}

\begin{enumerate}
  \item Realizar un componente software que implemente una interfaz de usuario adecuada para la evaluación psicotécnica colaborando con los objetivos principales del trabajo. 
\end{enumerate}

\subsection{Objetivos para el componente de software local y de nube}

\begin{enumerate}
  \item Realizar un sistema servidor-cliente donde se permitan obtener y enviar datos de personas evaluadas y de resultados de evaluación de forma segura y cifrada.
\end{enumerate}
...
El tiempo de reacción se define por la DGT (Dirección General de Tráfico) como el tiempo que pasa entre que un peligro aparece, y un conductor se percata del peligro. \cite{tiemporeaccion}

El tiempo estándar de un ser humano de reacción torna alrededor de unos 500 milisegundos y 1 segundo. \cite{tiemporeaccion2}

\subsection{Velocidad de anticipación}

Se define como la capacidad de un sujeto para percibir velocidades y trayectorias, y su capacidad de autocontrol \cite{velanticipacion}
...
La Protección de los Datos es un campo legal con una larga historia. \cite{apuntesprotecciondatos}

En este campo se busca regular todo lo relativo al uso de los datos personales de individuos físicos. \cite{apuntesprotecciondatos}

Dentro del marco de este proyecto, es muy relevante esta regulación, ya que trabajamos con datos personales de individuos físicos directamente, y es importante tomar medidas organizativas y técnicas para prevenir el uso ilícito de estos datos. \cite{apuntesprotecciondatos}

En territorio Europeo, todo esto se regula bajo el Reglamento General de Protección de Datos; regulación que se implementa en los territorios nacionales de la Unión Europea. \cite{apuntesprotecciondatos}

\subsubsection{Reglamento General de Protección de Datos}

Reglamento con última versión datada el 4 de Mayo de 2016. \cite{EuropeanParliament2016a}
...
\subsubsection{Ley Orgánica de Protección de Datos}

Implementa el marco legal instaurado con el Reglamento General de Protección de Datos a nivel Europeo en el marco legislativo Español. \cite{BOE2018a}
...
\begin{enumerate}
  ...
  \item A partir de entonces, mis tareas consistieron, sobre todo, de mandar mi memoria a revisar, e implementar las correcciones de la memoria correspondientes que mis tutores iban recomendando. También conseguí, a partir de un dominio de mi pertenencia, obtener certificados válidos SSL para la instancia EC2 en nube; terminando el flujo HTTPS adecuadamente
\end{enumerate}
...
\begin{itemize}
\item [RF1] El microcontrolador debe ser capaz de recibir tres tipos de mensajes específicos a partir del SBC (Single Board Computer); uno de entrada a la primera evaluación, otro de entrada a la segunda evaluación, y por último, uno general de salida.
...
\begin{itemize}
  \item [RF1] Deberán incluirse dos tipos de evaluación; una evaluación de tiempo de anticipación, y una evaluación de coordinación mano-ojo.
  \item [RF2] Los programas de evaluación deben mostrar feedback visual sin latencia excesiva al usuario en pantalla.
\end{itemize}
...
\begin{itemize}
  ...
  \item [RNF2] Los programas de evaluación no deben permitir memorización; es decir, debería depender la inicialización de los parámetros de evaluación de variables aleatorias.
  ...
  \item [RNF4] Los programas de evaluación deben almacenar los resultados de evaluación de forma veraz, que den posibilidad a su verificación y puntuación.
  \item [RNF5] Los programas de evaluación deben procesar información de los dispositivos electrónicos en un tiempo menor a 100ms
...
\begin{itemize}
  ...
  \item [RNF3] Los datos personales que se manden al servidor deben mandarse encriptados algorítmicamente.
\end{itemize}
...
\begin{itemize}
  ...
  \item [RNF2] Los datos personales que se manden al servidor deben mandarse encriptados algorítmicamente.
  \item [RNF3] Se deben considerar los documentos DNI y NIE para agregar sobre el usuario.
...
\caption{Diagrama electrónico de conexiones del proyecto. Diagrama realizado con Wokwi. Assets licenciados bajo \href{https://creativecommons.org/licenses/by/4.0/}{Creative Commons Attribution 4.0 International (CC-BY 4.0).}}
\end{figure}
...
La arquitectura que se ha utilizado para implementar este software de aplicación ha sido una \textbf{arquitectura modular}.
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{diagramaer.png}
\caption{Diagrama entidad-relación del proyecto. Diagrama generado por DBeaver.}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{DiagramaFlujoEmpotrados.png}
\caption{Diagrama visual del flujo de ejecución general de software para sistemas empotrados. Diagrama realizado con Draw.IO}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{DiagramaPrimeraEvaluacion_2.png}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{DiagramaSegundaEvaluacion_2.png}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{DiagramaFlujoWeb.png}
\caption{Diagrama visual del flujo de ejecución del cliente local. Diagrama realizado con Draw.IO}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{DiagramaCloud.png}
\caption{Diagrama visual del flujo de ejecución del componente cloud. Diagrama realizado con Draw.IO}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{casosdeuso1.png}
\caption{Caso de uso donde el evaluado se evalua. Diagrama realizado con Draw.IO}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{casodeuso2.png}
\caption{Caso de uso donde el evaluado otorga su información. Diagrama realizado con Draw.IO}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{casodeuso3.png}
\caption{Casos de uso entre auditoría y el doctor. Diagrama realizado con Draw.IO}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.1\textwidth]{casodeuso4.png}
\caption{Casos de uso para el atacante. Diagrama realizado con Draw.IO}
\end{figure}

\section{Demo en formato vídeo}

Se ofrece dentro del repositorio una serie de vídeos demostrativos. \cite{repo1}
...
\begin{enumerate}
  ...
  \item Inicialize ESP-IDF con el comando \begin{verbatim}source "$HOME/.espressif/tools/activate_idf_<version>.sh"\end{verbatim} 
...
Se han realizado algunas pruebas en el software de aplicación; se prueban los métodos dentro de cada fichero implementado de evaluación, asumiendo unos parámetros definidos específicos. Estos tests se realizan bajo la suite de tests GoogleTest.
...
Se han realizado algunas pruebas en el cliente local; sobre todo sobre las funciones relativas a las utilidades. Estos tests se realizan bajo la suite de tests Vitest.
...
\begin{enumerate}
  ...
  \item La función generateRandomString inicializada con un parámetro de longitud debería devolver un string de esa longitud multiplicada por 2 
\end{enumerate}

\section{Servidor en nube}

Se han realizado algunas pruebas en el servidor en nube; sobre todo sobre las funciones relativas a las utilidades. Estos tests se realizan bajo la suite de tests Vitest.
...
En estas pruebas, se compara un texto desencriptado y el equivalente encriptado; y se verifica que se compara de forma positiva a su hash

También se realiza una verificación sencilla con un mock del cliente de base de datos; donde se verifica que se devolverá un mensaje de error apropiado de no encontrarse el perfil correcto
...
Aún queda mucho por hacer relativo a este proyecto para realizar una suite de evaluaciones psicotécnicas para conductores que verdaderamente pueda ser comparable con sus precursores; esto no ha sido sino el comienzo de semejante esfuerzo.

\section{Retrospectiva}

Se han llegado a estas conclusiones, mirando hacia atrás en retrospectiva.

Se puede organizar un gran proyecto software a lo largo del tiempo; y también trabajar de forma efectiva con tecnologías desconocidas; No solo meramente aplicando lo aprendido; sino además, utilizando estrategias enfocadas a localizar recursos e información sobre aquello de lo que no se sabe que no se sabe.

La realización de un sistema tan multidisciplinar como lo es este requiere el uso de estrategias flexibles y bastante eclécticas; no solo hay que idear y seguir una planificación pautada para satisfacer resultados, como en cualquier otro tipo de proyecto; sino que también se ha de permanecer en un estado de aprendizaje contínuo por tiempo indefinido.

En muchas ocasiones, no todas las soluciones van a satisfacer todos los requisitos que se esperan; hay que saber elegir conforme a qué es lo mejor para el colectivo de todos los criterios; intentar focalizarse en un único criterio a maximizar en esta clase de proyectos es un enorme error.

La ciberseguridad es fundamental en este tipo de proyectos; se han de tener en cuenta los tipos más importantes de amenazas, y se han de implementar estrategias para combatirlas, en la medida de lo razonable.
...
Este programa no es capaz de realizar auditorías de forma automática a partir de datos en bruto, o de mantener un control estable de las versiones que se han utilizado; esto complica la auditoría en sí ya que asume que esta se hará de forma manual, conociendo la versión del programa específica que se utilizó en la evaluación en específico. En el mundo real, es muy posible que no sea posible asegurar este tipo de circustancias óptimas para poder realizar una auditoría manual. Se ha intentado mitigar esto ofreciendo datos en bruto para cada evaluación.

Las claves criptográficas se almacenan de forma local, dentro del dispositivo local utilizado para las evaluaciones, y sin nunca salir de ahí, sin siquiera a través de un protocolo de copias de seguridad; esto crea un riesgo de pérdida de disponibilidad de los datos personales si se pierden estas claves, considerándose una infracción según el Reglamento General de Protección de Datos. Es una decisión tomada debido a que la alternativa sería utilizar un servicio como Vault que almacenase la clave por nosotros, pero esto también puede incrementar la superficie de ataque al ser un servidor abierto a todo Internet; por lo que cualquier extensión de este estilo se ha dejado a considerar por futuros desarrolladores.
...
4. PELIGRO PELIGRO. Obtener toda la informacion desencriptada del hospital.
1
...
Para instalar el hardware, se necesitará un Raspberry Pi, una placa ESP32-DevKitV4, un cable USB de datos, dos potenciómetros, una placa breadboard, y suficientes cables puente.
\begin{enumerate}
\item Conecte el Raspberry Pi a la corriente eléctrica.
\item Conecte la placa ESP-32 a través de un cable USB-to-USB-C.
\item Introduzca el botón electrónico en la breadboard.
\item Conecte a corriente una de las patas del botón electrónico con el pin GPIO número número 13 según su layout de pins de la placa en específico.
\item Conecte a suelo la otra pata del botón electrónico.
\item Conecte cada uno de los potenciómetros siguiendo el siguiente procedimiento.
\item[\textbullet] Conecte una de las patas de las esquinas del potenciómetro a una corriente 3V3.
\item[\textbullet] Conecte la otra pata de las esquinas del potenciómetro a suelo.
\item[\textbullet] Por último, conecte la pata central del potenciómetro a un pin GPIO, \textbf{solo servirán aquellos con un canal ADC asignado.} Podrá verificar en su datasheet generalmente los pines adecuados para ello, que seguirán la siguiente plantilla "ADC<número>\_CH<número>" 
\end{enumerate}
...
\section{Instalación de software de aplicación}
...
\begin{enumerate}
  ...
  \item Incluya el siguiente parámetro dentro de su bloque server preferido: \begin{verbatim}
    location <ruta> {
...
\umaappendix{Ejemplo anexo de formulario de protección de datos}

Basado en el documento de política de privacidad de la Fundación Gestión y Participación Social. \cite{politicaprivacidad1}
