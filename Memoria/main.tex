...
También es costumbre hacer dos reuniones al final de cada sprint; con los interesados y clientes, y una reunión interna donde se evalua en retrospectiva el sprint anterior
...
Al ser solo una persona la implementadora de este proyecto, y al no haber un cliente específico; no aplican los métodos ágiles directamente en el sentido que comúnmente se realiza en empresas. Aquí se describe cómo se han modificado los procedimientos y metodologías habituales a los métodos ágiles para este contexto particular.

\subsubsection{Organización de tareas}

Las tareas se han ido organizando de forma semanal.

\subsubsection{Organización del tiempo}

Se ha organizado el tiempo utilizando la herramienta \textbf{Google Calendar}. Se han desarrollado objetivos semanales, los cuales se han ido incluyendo en el calendario, y se ha dado plazo de una semana para realizar; esto permite al desarrollador 
...
\begin{enumerate}
  \item Deberan incluirse dos tipos de evaluación; una evaluación de tiempo de reacción, y una evaluación de coordinación mano-ojo.
  \item Los programas de evaluación deben procesar información de los dispositivos electrónicos en un tiempo menor a 100ms
  \item Los programas de evaluación deben mostrar feedback visual sin latencia excesiva al usuario en pantalla.
  \item Los programas de evaluación deben almacenar los resultados de evaluación de forma veraz, que den posibilidad a su verificación y puntuación.
\end{enumerate}
...
\begin{enumerate}
  \item Los programas de evaluación deberán ser fácilmente interpretables para los usuarios.
  \item Los programas de evaluación no deben permitir memorización.
  \item Los programas de evaluación deben adherirse a las mejores prácticas técnico-científicas para recolectar información psicotécnica. 
\end{enumerate}
...
\begin{enumerate}
  ...
  \item El programa ofrece una opción para mandar datos de evaluaciones al servidor.
  \item El programa ofrece una opción para obtener datos de evaluaciones al servidor.
...
\begin{enumerate}
  \item \textbf{ResetTestActuallyAffectsTheCar}
\end{enumerate}
...
\item \textbf{PositionsAreAssignedCorrectly}
\item \textbf{VerifyCollisionVerifiesCorrectly}
\item \textbf{VerifyResolvePosition}
\end{enumerate}
