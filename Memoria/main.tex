...
El principal dispositivo de la compañía consiste en el LND-100 \cite{lndeter1}; el cual se comenzó a desarrollar por el propio fundador de la compañía, Fernando Ortiz, y un amigo suyo. Francisco Ortiz se iría después a Londrés, y habría desarrollado su idea. \cite{lndeter3}
...
Esta legislación es fundamentalmente relevante para los desarrolladores de productos destinados a estos centros; ya que estos productos se deben desarrollar de forma que sean immediatamente compatibles con las obligaciones que impone el derecho sobre ellos.
...
Se validan los datos de los documentos de identidad españoles bajo el reglamento oficial que se especifica en https://www.interior.gob.es/opencms/es/servicios-al-ciudadano/tramites-y-gestiones/dni/calculo-del-digito-de-control-del-nif-nie/
...
Se demuestra la funcionalidad de examinación a partir de la realización de las dos examinaciones, utilizado los dispositivos electrónicos a tal efecto; y también se ofrece una demostración de adición de un examinado y sus resultados al servidor en nube, junto con su posterior recepción como archivo .html
...
Se han realizado algunas pruebas en el software de sistemas; se prueban los métodos dentro de cada fichero implementado de examinación, asumiendo unos parámetros definidos específicos. Estos tests se realizan bajo la suite de tests GoogleTest.
