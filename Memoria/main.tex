...
ASDE comercializa su dispositivo ASDE DRIVER TEST N-845; que utiliza por
dentro el programa de ordenador denominado AUTO-TEST; originalmente implementado
para dispositivos MSX por el equipo del profesor Héctor Monterde
...
Una Placa de pruebas, o mejor conocido por el anglicismo *breadboard*, es una placa electrónica que se utiliza para realizar circuitos electrónicos sin la necesidad de realizar soldaduras. Es generalmente utilizado en el desarrollo de prototipos, y contrasta con los circuitos soldados o circuitos impresos.\cite{eswiki:172543964}

\subsubsection{Botón pulsador electrónico}

Un button pulsador electrónico consiste en una resistencia que no deja pasar la corriente cuando se activa un pulsador.
